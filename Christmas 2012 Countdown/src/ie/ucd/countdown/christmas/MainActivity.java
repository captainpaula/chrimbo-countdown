package ie.ucd.countdown.christmas;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		int min = Integer.parseInt(sc.next());
        		...
        		//get the date of Christmas
     			Calendar chrimboDay = new GregorianCalendar(year, month, day, hour, min);
     			
     			//get the time right now
     			Calendar rightNow = new GregorianCalendar();
 
     			// get difference in milliseconds
     			milliseconds = (chrimboDay.getTimeInMillis()-rightNow.getTimeInMillis());
    ...
    public class MyCount extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished) {
			...
			chrimbo = days + ":" + hours + ":" + minutes + ":" + seconds;
			count_down.setText(chrimbo);
